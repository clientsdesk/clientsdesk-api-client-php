...
namespace Clientsdesk\API\Resources;

use Inflect\Inflect;
use Clientsdesk\API\HttpClient;
use Clientsdesk\API\Exceptions\RouteException;
use Clientsdesk\API\Traits\Utility\ChainedParametersTrait;
...
abstract class ResourceAbstract
{
    ...
    /**
     * @var \Clientsdesk\API\HttpClient
     */
    protected $client;
     ...
     *      ['messages' => '\Clientsdesk\API\Resources\Messages']
     *
     * @return array
     */
