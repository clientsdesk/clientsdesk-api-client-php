 ...
 * An example would be a call `$client->message(2)->comments(3)->author();` would create an Author object with
 * chained parameters (An Array):
 *  [
 *      'Clientsdesk\API\Messages' => 2,
 *      'Clientsdesk\API\Comments' => 3
 *  ]
...
trait ChainedParametersTrait
{
     ...
     *                      e.g. ['message_id' => 'Clientsdesk\API\Message']
